...
import com.recipe.service.IEmailService;
import com.recipe.service.IUserMgmtService;
...
public class HomeController {
	...
	public String getHome(Model model) {
		...
		model.addAttribute("title", "Home - Recipe Management System");
		return "home";
	...
	public String getAbout(Model model) {
		...
		model.addAttribute("title", "About - Recipe Management System");
		return "about";
	...
	public String getSignup(Model model) {
		...
		model.addAttribute("title", "Signup - Recipe Management System");
	...
	public String getSigin(Model model) {
		...
		model.addAttribute("title", "Signin - Recipe Management System");
		return "login";
