		...
		<div class="content">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							...
							<li class="nav-item"><a class="nav-link"
								href="sololearn.jsp"><span class="fa"></span> SoloLearn</a></li>
							<li class="nav-item"><a class="nav-link"
								href="https://www.programiz.com/c-programming/online-compiler/"><span
									class="fa"></span> {/} Code here</a></li>
						</ul>
						...
						<ul class="navbar-nav mr-right">
							...
							<li class="nav-item"><a class="nav-link" href="#"
								data-bs-toggle="modal" data-bs-target="#profile-model"><img
									...
									src="./pictures/<%=user.getProfile()%>" width="28px"
									style="border-radius: 24px;"> <%=user.getName()%></a></li>

							<li class="nav-item"><a class="nav-link"
								href="LogoutServlet"><span class="fa fa-child"></span>
									Logout </a></li>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-3 p-5">
						<div class="card"
							style="width: 18rem; overflow: auto; height: 440px;">
							...
							<ul class="list-group list-group-flush">
								<li class="list-group-item"><a
									...
									class="card-link text-dark">code with harry</a></li>
								<li class="list-group-item"><a
									href="https://youtu.be/sCOw5y1RQpY?si=oMpkBxQa29FkgVjP"
									class="card-link text-dark">One short</a></li>
								<li class="list-group-item"><a
									href="https://youtube.com/playlist?list=PLLOxZwkBK52DmuHRO3UNpqAzDF57FtIxk&si=uUljJe4VUqeqlA5v"
									class="card-link text-dark">Sundeep Saradhi Kanthety</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="card" style="width: 18rem; height: 440px;">
							...
							<ul class="list-group list-group-flush">
								<li class="list-group-item"><a
									...
									class="card-link text-dark">Techblog</a></li>
								<li class="list-group-item"><a
								...
								<li class="list-group-item"><a
									...
									class="card-link text-dark">KG coading</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="col-lg-3 p-5">
						<div class="card" style="width: 18rem; height: 440px;">
							...
							<div class="card-body">
								...
								<p class="card-text">CSS is the language we use to style an
						...
						<div class="card" style="width: 18rem; height: 440px;">
							...
							<ul class="list-group list-group-flush">
								<li class="list-group-item"><a
									...
									class="card-link text-dark">WsCube Tech</a></li>
								<li class="list-group-item"><a
									href="https://youtube.com/playlist?list=PLYwpaL_SFmcCRFzBkZ-b92Hdg-qCUfx48&si=Ga8Yk_GqHv9Mdmh4"
									class="card-link text-dark">5 Minutes Engineering</a></li>
								<li class="list-group-item"><a
						...
						<div class="card" style="width: 18rem;">
							...
							<ul class="list-group list-group-flush">
								<li class="list-group-item"><a
									...
									class="card-link text-dark">QAFox</a></li>
								<li class="list-group-item"><a
						...
						<div class="card" style="width: 18rem;">
							...
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item"><a
									...
									class="card-link text-dark">Yahoo Baba</a></li>
								<li class="list-group-item"><a
									href="https://www.youtube.com/live/Rkvn_MA04fo?si=7DJyjzVLxaFwKNDX"
									class="card-link text-dark">Simplelearn</a></li>
							</ul>
						</div>
					</div>
				</div>
